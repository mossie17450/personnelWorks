<!--                                                                                                                            -->
<!-- gestion des sessions, permet de conserver le choix le la langue au cour de la navigation sur les différentes pages du site -->
<!--                                                                                                                            -->
<?php
session_start();
?>
...
<div id="header">
<img src="../image/headerGG.jpg" width="100%" height="150px" class="arrondie" /></div><!-- a optimiser en responsive -->
...
<div class="img" style="position:relative; top:5%; left:150%; width:200%;">
 <a target="_blank" href="PhotoGroupeCIC-IT2017.php">
   <?php
		if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false) || (strpos($_SERVER['HTTP_USER_AGENT'], 'windows phone') !== false)) {
			
			echo "<img src=\"../image/photoGroupeCICIT1.jpg\" width=\"20%\" >";
		}
  ...
  <div><? echo "le groupe du CIC-IT, 2017.";   ?></div>
	</div>
