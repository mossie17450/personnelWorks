...
<table class="ex2" width="100%"><tr colspan="5"><td colspan="2" style="padding-right:5px;">

	<div class="img" style="border:none; margin-right:5%; width:100%;">
...
";
	...
	<div style=" width:100%;"><?php echo "<br><h2>Dr vétérinaire Lionel Couraud</h2>Laboratoire d'Anatomie Pathologique Vétérinaire du Sud Ouest<br>31 200 Toulouse<br>Courriel: <a href=\"mailto:L.couraud@lapv80.fr\">L.couraud@lapv80.fr</a> ";   ?>
	<?php echo "<article>Le Dr Couraud apporte son expertise d'anatomo-pathologiste des tissus vétérinaires sur les coupes préparées à partir d'explants.<br>Il caractèrise la réaction inflammatoire et le comportement du matériau, in situ et dans le temps.</article>" ?>
</div>
</td></tr></table>
</div>
</div>
