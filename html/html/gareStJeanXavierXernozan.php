...
<div class="img" style="position:relative; top:5%; left:5%; width:100%;">
 <a target="_blank" href="gareStJeanXavierXernozan.php"><!-- lien quand on clique sur l'image....   -->
   <?php
		if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false) || (strpos($_SERVER['HTTP_USER_AGENT'], 'windows phone') !== false)) {
			
			echo "<img src=\"../image/gareStJeanXavierXernozan.png\" width=\"100%\" >";
		}
		else {
  ...
  <div><?php echo "de la gare Saint Jean (Bordeaux) vers le CIC-IT à l'hopital Xavier Xernozan"; ?></div>
</div>
