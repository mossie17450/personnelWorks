...
<div class="img" style="position:relative; top:5%; left:20%;">
   ...
   <?php
		if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false) || (strpos($_SERVER['HTTP_USER_AGENT'], 'windows phone') !== false)) {
			...
			echo "<img src=\"../image/equipements/tienturierHMS70.jpg\" width=\"70%\" >";
		}
		else {
		...
		?>
 <br>
  <div><?php echo "Automate de coloration \"Microm Microtech HMS 70 MYR\"<br>mis à disposition par la PTIB.";   ?></div>
	</div>
